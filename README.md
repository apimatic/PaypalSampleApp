...
This application was built using an SDK generated by [APIMatic](https://www.apimatic.io/). The Spotify Web API SDK was generated through APIMatic's code generation engine. You can explore the full API portal [here](https://spotify-poc-apimatic.pages.dev/#/typescript/quick-start/overview).

## Demo

[Watch Video Demo](https://drive.google.com/file/d/1tT6yBamSEBe-YueC7otSe0n_7g1qZbox/view?usp=sharing)
...
git clone https://github.com/apimatic/spotify-sample-app.git
cd spotify-sample-app
...
- [APIMatic Portal for Spotify Web API](https://spotify-poc-apimatic.pages.dev/#/typescript/quick-start/overview)
